...
using UserManagement.Application.Features.ActivityLog.Queries.GetUserLogs;
using UserManagement.Application.Interfaces.Shared;
using UserManagement.Web.Abstractions;
using MediatR;
...
namespace UserManagement.Web.Areas.Identity.Pages.Account
{
