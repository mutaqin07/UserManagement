...
using UserManagement.Application.DTOs.Settings;
...
using UserManagement.Infrastructure.Shared.Services;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\UserManagement.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
